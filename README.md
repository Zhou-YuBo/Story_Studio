...
Story Studio 是一款帮助创作者组织灵感、人物、结构、场景和创作约束的 Story Operating System。
...
Story Studio 是一个为小说作者、编剧、游戏叙事设计师、动画导演等长篇故事创作者准备的本地桌面工作台。

它关注的不是生成一段文本，而是把故事背后的复杂系统搭起来：灵感碎片、世界规则、人物动力、结构曲线、场景推进、节拍拆分、创作提醒，最终汇入可以持续创作和复盘的项目文件。

当前项目处于 MVP 收尾阶段。七个核心工作台已经接入，项目保存、导入、开屏和项目大厅原型已经落地，接下来重点继续打磨保存体验、导出能力和发布前的稳定性。
...
Story Studio 希望做的是一个创作者掌控的故事控制台：不替创作者判断故事好坏，而是让故事系统可视化、可编辑、可追踪。
...
<table>
  ...
  <tr>
    <td><b>导出</b></td>
    <td>输出层</td>
    <td>导出工作台已预留，后续会围绕 PDF 和项目资料输出继续完善。</td>
  </tr>
</table>
...
当前阶段优先保证本地桌面体验和项目文件可控。项目数据以 JSON 文件为核心进行保存、另存为和导入。
...
<table>
  ...
  <tr>
    <td>开屏与项目大厅</td>
    <td>原型已接入</td>
    <td>启动流程、项目入口和大厅视觉已经接入，仍会继续打磨项目管理细节。</td>
  </tr>
  <tr>
    <td>底部七工作台导航</td>
    <td>已完成 MVP</td>
  ...
  <tr>
    <td>项目保存</td>
    <td>已接入，继续打磨</td>
    <td>项目 JSON 保存、另存为、导入已接入，仍在完善边界体验和异常恢复。</td>
  </tr>
  <tr>
    <td>PDF 导出</td>
    <td>待完成</td>
